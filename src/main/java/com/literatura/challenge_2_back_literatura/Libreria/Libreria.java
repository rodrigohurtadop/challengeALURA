...
public class Libreria {
        ...
        while (opcion != 0){
            ...
            switch (opcion){
                ...
                case 0:
                    opcion = 0;
                    System.out.println("|********************************|");
                    System.out.println("|    Aplicación cerrada. Adiós!    |");
                    System.out.println("|********************************|\n");
                    break;
                default:
                    System.out.println("|*********************|");
                    ...
                    System.out.println("|*********************|\n");
                    System.out.println("Intente una nueva Opción");
                    consumo();
                    break;
            }
        }
    ...
    private void buscarLibroEnLaWeb() {
        ...
        try{
            ...
            if (libroExists){
                System.out.println("El libro ya está ingresado en la base de datos!");
            }else {
    ...
    private void  buscarLibrosPorIdioma(){
        ...
        System.out.println("|***********************************|");
        System.out.println("|  Opción - es : Libros en el idioma español. |");
        System.out.println("|  Opción - en : Libros en el idioma inglés.  |");
        System.out.println("|***********************************|\n");
